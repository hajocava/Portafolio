          ...
          <div className="row">
            <div className="col-12 col-md-6">
              ...
              <p>
                ...
                Morelia, who perform their social service within this
                institution. How main objective, is to facilitate access to
                information of each of the necessary files and documents.
              </p>
            </div>
            <div className="col-12 col-md-6">
              <h2>Challenges</h2>
          ...
          <div className="row mt-5">
            <div className="col-12 col-lg-6">
              ...
              <p>
                ...
                difficult for you to do on your normal work day? What is the
                scope I want this project to have?
              </p>
              <p>
